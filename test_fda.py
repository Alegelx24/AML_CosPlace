...
def FDA_database_transform2(database_path, queries_path, output_dir, weight= 0.01):
    ...
    for root, dirs, files in os.walk(database_path):
        for filename in files:
           # if random.randint(1, 59) == 1:  # Apply FDA to every 59th image
...
def convert_all_to_night(folder_path, output_folder_path, brightness_factor=0.5):
    ...
    for filename in os.listdir(folder_path):
        ...
        # Adjust brightness by reducing pixel values
...
def add_fake_light(image):
    ...
    # Set the number of small lights to add
    num_lights = 10
    ...
    # Clip the image array values to the valid range
    image_array = np.clip(image_array, 0, 255)

    # Convert the image array back to PIL format
...
if __name__ == "__main__":
   ...
   # FDA_database_transform2("/Users/aleg2/Desktop/sf-xs/train","/Users/aleg2/Desktop/tokyo_night/test"+"/queries_v1","/Users/aleg2/Desktop/sf_xsFDA002", 0.01)
    convert_all_to_night_V2("/Users/aleg2/Desktop/sf_xsFDA002","/Users/aleg2/Desktop/SFXS_FDA001NIGHTCOLORED_V2_entire")
