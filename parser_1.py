...
def parse_arguments(is_training: bool = True):
    ...
    parser.add_argument("--backbone", type=str, default="ResNet18",
                        choices=["VGG16", "ResNet18", "ResNet50", "ResNet101", "ResNet152","mobilenet_v3_small","mobilenet_v3_large","efficientnet_v2_s","maxvit_t","regnet_y_1_6gf", "convnext_small", "regnet_y_16gf",
                                  "ConvNext_base", "ConvNext_tiny", "efficientnet_v2_l",  "squeezenet1_1","efficientnet_b0","resnext50_32x4d","vit_b_32","resnext50_32x4d", "swin_t","SWIN_V2_B", "shufflenet_v2_x2_0", "regnet_y_1_6gf"], help="_")
